...
- [#121](https://github.com/phmilk/reforged-ts/pull/121) [`667e252`](https://github.com/phmilk/reforged-ts/commit/667e252441f3e174bf2284bb4bc669ee08f420da) Thanks [@wyller](https://github.com/wyller)! - Initial release: the lint layer of the Guards. Twelve type-aware rules report the Warcraft III scripting pitfalls (desync, crash, leak) of a Map project before it compiles: six errors and six warnings, all enabled by `configs.recommended`.
  ...
  **The allowlist.** `data/local-safe.json` lists the Natives and library members that only change what the local player sees or hears (`visual`: frame setters, vertex colours, the camera, sounds and music) or that display a string (`text`), and the Natives whose result depends on their arguments alone (`pure`: `I2S`, `R2S`, `SquareRoot`, `SubString`, ...), each with its reason. A file with an unexpected shape throws at plugin load, naming the field.
...
- Updated dependencies [[`8c2a87a`](https://github.com/phmilk/reforged-ts/commit/8c2a87a88822a03abba648aa6f0f22b143146151), [`05eda1a`](https://github.com/phmilk/reforged-ts/commit/05eda1a99bce016ef10483143216260bd706e482), [`70d7b4d`](https://github.com/phmilk/reforged-ts/commit/70d7b4d7f67efca2c5ff0e7d0c1721390971b5da), [`71b1c1c`](https://github.com/phmilk/reforged-ts/commit/71b1c1cd64316b1f42e58f4643902afd87f32d47), [`fc96e92`](https://github.com/phmilk/reforged-ts/commit/fc96e92caf9e6ef69a0db9ebf42f1476ed413461), [`09037e0`](https://github.com/phmilk/reforged-ts/commit/09037e0899ea6cf5c2c82f6b9cc1c6c7ecf23ed9), [`ab8b7ba`](https://github.com/phmilk/reforged-ts/commit/ab8b7ba6d1c4cecaf2a8a91b7f194e8880106f4b), [`789a5f5`](https://github.com/phmilk/reforged-ts/commit/789a5f5111dfac5adc7dc1ee8d47811e3a6623f3), [`4c0b745`](https://github.com/phmilk/reforged-ts/commit/4c0b74595133bf19df2a45875f1f5c5bd2519c9b)]:
