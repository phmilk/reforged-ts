...
describe("the clock", function()
  it("answers 0.0 until set, keeps a set value until set again, and records nothing", function()
    local mark = #runner.stubCalls()
    expect(os.clock()).toEqual(0.0)
    expect(__stub_set_clock(12.5)).toEqual(0.0)
    expect(os.clock()).toEqual(12.5)
    expect(os.clock()).toEqual(12.5)
    expect(__stub_set_clock(3.0)).toEqual(12.5)
    expect(os.clock()).toEqual(3.0)
    expect(#runner.stubCalls()).toEqual(mark)
  end)
end)
