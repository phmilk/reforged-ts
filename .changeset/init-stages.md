...
**Removed** (each listed in `migration/renames.json`): the old Hook code's helpers `hookedMain`, `hookedConfig`, `executeHooksMainBefore`, `executeHooksMainAfter`, `executeHooksConfigBefore` and `executeHooksConfigAfter`.
